    ...
    >
      ...
      <div
        ...
        <button
          ...
          class="absolute left-0 top-1/2 transform -translate-y-1/2 dark:bg-gray-300 bg-gray-800 p-2 rounded-full"
          @click="previousImage"
        >
          &#8592;
        </button>
        ...
        <!-- Main Image Display -->
        <img
          v-if="event.images[currentImageIndex].image_url"
      ...
      <a
        ...
        class="text-gray-700  dark:text-white font-semibold hover:text-blue-500 dark:hover:text-blue-500 hover:underline"
      >Update</a>
    </div>
  </div>
</template>
